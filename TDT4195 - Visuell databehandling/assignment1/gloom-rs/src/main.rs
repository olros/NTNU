...
fn main() {
    ...
    let render_thread = thread::spawn(move || {
        ...
        let coordinates: Vec<f32> = vec![
            -0.90, -0.90, 0.0, -0.60, -0.90, 0.0, -0.75, -0.60, 0.0, 0.60, -0.90, 0.0, 0.90, -0.90,
            0.0, 0.75, -0.60, 0.0, 0.90, 0.90, 0.0, 0.60, 0.90, 0.0, 0.75, 0.60, 0.0, -0.60, 0.90, 0.0,
            -0.90, 0.90, 0.0, -0.75, 0.60, 0.0, -0.33, -0.33, 0.0, 0.33, -0.33, 0.0, 0.0, 0.33, 0.0,
        ];
        ...
        let triangle_indices: Vec<u32> = (0..((coordinates.len() as u32 + 1) / 3)).collect();
        
        // 2b)
        // let triangle_indices: Vec<u32> = vec![0, 2, 1];

        unsafe {
          let my_vao = create_vao(&coordinates, &triangle_indices);
        ...
        loop {
            ...
            unsafe {
                ...
                let num_of_triangles: i32 = (coordinates.len() as i32) / 3;
                let num_of_indices = 3 * num_of_triangles;
                gl::DrawElements(
                    gl::TRIANGLES,
                    num_of_indices,
